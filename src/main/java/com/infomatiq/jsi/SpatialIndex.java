...
public interface SpatialIndex {
   ...
   * no matter how far away, although this will slow down the algorithm.
   */
  public void nearestN(Point p, TLongProcedure v, int n, float distance);
   ...
   */
  public void nearestNUnsorted(Point p, TLongProcedure v, int n, float distance);
   ...
   */
  public void intersects(Rectangle r, TLongProcedure ip);  
   ...
   */
  public void contains(Rectangle r, TLongProcedure ip); 
