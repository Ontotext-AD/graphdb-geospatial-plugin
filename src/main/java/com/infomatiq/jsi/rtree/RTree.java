...
public class RTree implements SpatialIndex {
  ...
  private long highestUsedNodeId = rootNodeId; 
  ...
  //  nearest(Point, TLongProcedure, float)
  //  intersects(Rectangle, TLongProcedure)
  //  contains(Rectangle, TLongProcedure)
  //  size()
  //-------------------------------------------------------------------------
  /**
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#add(Rectangle, long)
   */
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#delete(Rectangle, long)
   */
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#nearest(Point, TLongProcedure, float)
   */
        ...
        for (int i = 0; i < n.entryCount; i++) {
          ...
          if (entryDistanceSq <= furthestDistanceSq) {
            ...
            while (distanceQueue.size() > count) {
              ...
              long value = distanceQueue.getValue();
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#nearestNUnsorted(Point, TLongProcedure, int, float)
   */
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#nearestN(Point, TLongProcedure, int, float)
   */
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#contains(Rectangle, TLongProcedure)
   */
