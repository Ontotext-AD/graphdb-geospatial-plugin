...
public class SortedList {
  ...
  private TLongArrayList ids = null;
  ...
  public SortedList() {
    ids = new TLongArrayList(DEFAULT_PREFERRED_MAXIMUM_SIZE);
    priorities = new TFloatArrayList(DEFAULT_PREFERRED_MAXIMUM_SIZE);
  }
  
  public void add(long id, float priority) {
  ...
  public void forEachId(TLongProcedure v) {
